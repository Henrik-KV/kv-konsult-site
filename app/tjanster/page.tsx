...
const serviceCategories = [
  ...
  },
  {
    id: "webbsidor",
    title: "Webbsidor",
    subtitle: "Hemsidor med löpande underhåll",
    description: "Vi designar, bygger, kopplar upp och underhåller professionella hemsidor. Listpriset är 9 999 kr i startavgift och därefter tillkommer löpande underhåll.",
    ...
    features: [
      "9 999 kr i startavgift",
      "Modern och responsiv design",
      "Löpande underhåll och upp till två enklare ändringar per månad",
      "Månadsfaktura 699 kr eller årsfaktura 5 988 kr, exkl. moms",
    ],
  },
  {
    id: "sociala-medier",
