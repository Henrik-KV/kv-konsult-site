...
function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      {/* Spiral-video – lazy-laddad, hoppas över på mobil & vid reduced motion */}
      <VideoBackground videoSrc="/images/spiral-effekt.mp4" brightness={1.3} overlayOpacity={0.4} />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-300 sm:mt-6 sm:text-lg md:text-xl animate-fade-in-up animation-delay-100">
              Vi hjälper företag, kommuner och organisationer att komma igång med AI – genom utbildning, workshops, strategi och skräddarsydda digitala lösningar. Konkret nytta, utan krångel.
            </p>
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:mt-10 sm:flex-row sm:gap-4 lg:justify-start animate-fade-in-up animation-delay-200">
              ...
              >
                <span className="relative z-10">Boka kostnadsfritt samtal</span>
...
function StatsSection() {
  ...
  return (
    <section className="relative z-10 pt-12 sm:pt-16 pb-8 sm:pb-12 overflow-hidden">
      {/* Fortsatt video-bakgrund som kopplar ihop med hero – lazy-laddad */}
      <VideoBackground videoSrc="/images/bakgrund-partiklar.mp4" brightness={0.9} overlayOpacity={0.55} />
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-900/70 p-4 sm:p-8 backdrop-blur-md shadow-2xl shadow-sky-500/5">
          ...
          <div className="grid gap-3 sm:gap-6 grid-cols-1 sm:grid-cols-3">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-lg sm:rounded-xl ${stat.iconBg} shrink-0`}>
                  {stat.icon}
                </div>
...
const services = [
  {
    ...
    title: "Utbildning & AI",
    text: "Föreläsningar och workshops kring AI, Microsoft 365 Copilot och digitalisering – praktiskt, begripligt och anpassat för hela organisationen.",
    href: "/utbildning-ai",
  },
  {
...
function TestimonialsSection() {
  ...
  // Klampa index vid resize – beräknas vid render istället för i en effekt
  ...
  // Auto-rotation – pausas vid hover/fokus och respekterar reduced motion
  useEffect(() => {
    if (isPaused) return;
