...
/* ═══════════════════════════════════════════════════════════════════════════
   PAKET DATA - Föreläsningar, Workshops, Analys & Partnerskap
═══════════════════════════════════════════════════════════════════════════ */
const packages = {
  microsoft365: {
    id: "microsoft365",
        ...
        >
          <div className="space-y-6 border-t border-white/10 pt-6">
            ...
            <div className="pt-2">
              <Link
                href={`/kontakt?type=paket&packages=${packageId}`}
                className={`inline-flex items-center justify-center rounded-full ${colors.bg} px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl`}
              >
                Boka {level.name}
              </Link>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-8 sm:pt-12 md:pt-16 lg:pt-20 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 sm:mt-6 max-w-3xl text-base sm:text-lg text-slate-300 md:text-xl px-2">
              Föreläsningar, workshops och rådgivning som gör AI begripligt och användbart. Kombinera, skräddarsy och bygg ett upplägg som passar just er organisation.
            </p>
          </div>
                  ...
                  <div className={`flex flex-col justify-center pl-1 ${pkgIndex % 2 === 1 ? 'lg:order-2' : ''}`}>
                    ...
                    <h2 className="mt-3 sm:mt-4 text-2xl sm:text-3xl font-bold text-white md:text-4xl">
                      {pkg.id === 'microsoft365' ? (
                        ...
                        <>Praktiska <span className="text-cyan-400">workshops</span></>
